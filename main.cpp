            ...
            while (true)
            {
                ...
                if (addDataOption == 1)
                {
                    ...
                    for (int i = 0; i < loopKerajinanDataAdd; i++)
                    {
                        ...
                        cout << "Masukkan data tanpa koma (namaKerajinan, namaPengrajin, stok): ";
                        cin >> infoKerajinan(P).namaKerajinan >> infoKerajinan(P).namaPengrajin >> infoKerajinan(P).stok;
                ...
                else if (addDataOption == 2)
                {
                    ...
                    for (int i = 0; i < loopPasarDataAdd; i++)
                    {
                        ...
                        cout << "Masukkan data tanpa koma (namaPasar, lokasi): ";
                        cin >> infoPasar(Q).namaPasar >> infoPasar(Q).lokasi;
                        nextPasar(Q) = NULL;
